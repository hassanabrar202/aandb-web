            ...
            <div className='px-8'>
                ...
                >
                    ...
                    <SwiperSlide className='py-8'>
                        <Image
                            onClick={() => navigate('/dashboard')}
                            src='https://images.unsplash.com/photo-1574068468026-2d19b85e69bf?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NjN8fGJpcmRzfGVufDB8fDB8fHww'
                            alt=''
                            style={{ width: '400px', height: '300px', objectFit: 'cover' }}
                            isZoomed={true}
                        />
